...
class RuleRBranch : Rule {
    ...
    public override List<ISymbol> genOutput() {
        ...
        List<ISymbol> result = new List<ISymbol>{
            ...
            new Symbol("B", 0, new RuleAttributes(), new RoadAttributes(Vector3.Zero, Vector3.Zero, 0f, 0f, 0f, Vector3.Zero, Vector3.Zero), StateType.UNASSIGNED),       // Branch 1
            new Symbol("B", 0, new RuleAttributes(), new RoadAttributes(Vector3.Zero, Vector3.Zero, 0f, 0f, 0f, Vector3.Zero, Vector3.Zero), StateType.UNASSIGNED),       // Branch 2
            new Symbol("R", 0, new RuleAttributes(), new RoadAttributes(Vector3.Zero, Vector3.Zero, 0f, 0f, 0f, Vector3.Zero, Vector3.Zero), StateType.UNASSIGNED),       // Road
            new Symbol("?I", 0, new RuleAttributes(), new RoadAttributes(Vector3.Zero, Vector3.Zero, 0f, 0f, 0f, Vector3.Zero, Vector3.Zero), StateType.UNASSIGNED)       // Insertion query
        };
        return result;
    }
}
...
class RuleB : Rule {
    ...
    public override List<ISymbol> genOutput() {
        List<ISymbol> result = new List<ISymbol>();
        if (vars["del"] > 0) {
            Symbol Bsym = new Symbol("B", vars["del"] - 1, new RuleAttributes(), roadAttr, StateType.UNASSIGNED);
            result.Add(Bsym);
        } else if (vars["del"] == 0) {
            SymBranch BSym = new SymBranch();
            Symbol R = new Symbol("R", vars["del"], new RuleAttributes(), roadAttr, StateType.UNASSIGNED);
            Symbol I = new Symbol("?I", -1, new RuleAttributes(), roadAttr, StateType.UNASSIGNED);
            BSym.Syms.Add(R);
            BSym.Syms.Add(I);
            result.Add(BSym);
        }
...
class RuleI : Rule {
    ...
    public override List<ISymbol> genOutput() {
        List<ISymbol> result = new List<ISymbol>();
        Symbol newISym = new Symbol("?I", -1, new RuleAttributes(), new RoadAttributes(Vector3.Zero, Vector3.Zero, 0f, 0f, 0f, Vector3.Zero, Vector3.Zero), StateType.UNASSIGNED);
        result.Add(newISym);
        return result;
    }
}
...
class RuleA : Rule {
    ...
    public override List<ISymbol> genOutput() {
        List<ISymbol> result = new List<ISymbol>();
        result.Add(new Symbol("A", del, new RuleAttributes(), roadAttr, StateType.UNASSIGNED));
        return result;
    }
}