...
class RuleRBranch : Rule {
    ...
    public override List<ISymbol> genOutput() {
        ...
        List<ISymbol> result = new List<ISymbol>{
            ...
            new Symbol("B", 0, ruleAttr, new RoadAttributes(Vector3.Zero, Vector3.Zero, Vector3.Zero, 0f, 0f, RoadType.NONE, 3), StateType.UNASSIGNED),       // Branch 1
            new Symbol("B", 0, ruleAttr, new RoadAttributes(Vector3.Zero, Vector3.Zero, Vector3.Zero, 0f, 0f, RoadType.NONE, 3), StateType.UNASSIGNED),       // Branch 2
